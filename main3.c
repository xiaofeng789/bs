...
void load_css() {
    ...
    gtk_css_provider_load_from_file(provider, gtk_file_name_to_uri("styles.css", NULL), NULL);

    GtkStyleContext *context = gtk_widget_get_style_context(gtk_widget_get_default());
...
int main(int argc, char *argv[]) {
    ...
    gtk_widget_set_size_request(button1, 120, 60); // 设置按钮大小
    gtk_widget_set_size_request(button2, 120, 60);
    gtk_widget_set_size_request(button3, 120, 60);
